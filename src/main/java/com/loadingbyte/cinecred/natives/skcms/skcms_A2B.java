...
public class skcms_A2B {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(4, skcms_Curve.layout()).withName("input_curves"),
        ...
        MemoryLayout.paddingLayout(4),
        MemoryLayout.sequenceLayout(3, skcms_Curve.layout()).withName("output_curves")
    ).withName("skcms_A2B");
    ...
    private static long[] input_curves$DIMS = { 4 };
    ...
    private static long[] output_curves$DIMS = { 3 };
