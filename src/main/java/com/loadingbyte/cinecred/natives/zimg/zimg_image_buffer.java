...
public class zimg_image_buffer {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(4, zimg_image_buffer.plane.layout()).withName("plane")
    ...
    public static void plane(MemorySegment struct, long index0, MemorySegment fieldValue) {
        MemorySegment.copy(fieldValue, 0L, plane(struct, index0), 0L, zimg_image_buffer.plane.layout().byteSize());
    }
