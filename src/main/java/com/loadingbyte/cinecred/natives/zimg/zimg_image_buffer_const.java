...
public class zimg_image_buffer_const {
    ...
    public static MemoryLayout $LAYOUT() {
        return zimg_image_buffer_const.$struct$LAYOUT;
    }
    static final VarHandle version$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("version"));
    public static VarHandle version$VH() {
        return zimg_image_buffer_const.version$VH;
    }
    public static int version$get(MemorySegment seg) {
        return (int)zimg_image_buffer_const.version$VH.get(seg);
    }
    public static void version$set( MemorySegment seg, int x) {
        zimg_image_buffer_const.version$VH.set(seg, x);
    }
    public static int version$get(MemorySegment seg, long index) {
        return (int)zimg_image_buffer_const.version$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void version$set(MemorySegment seg, long index, int x) {
        zimg_image_buffer_const.version$VH.set(seg.asSlice(index*sizeof()), x);
    }
